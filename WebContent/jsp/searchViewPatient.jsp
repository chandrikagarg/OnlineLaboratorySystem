...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a href="JSP/searchViewPatient.jsp">Search Patient</a>
...
<%Patient p=(Patient) request.getAttribute("msg");%>
<p align="center">
<% 
if(p!=null)
{
...
<div class="table table-resonsive profile-data">
	<table class="table table-responsive table-bordered" align="center" >
			<tr> <td> Patient Id </td>
				...
				<td><%=p.getInsuranceCover() %></td>
				</tr>
				<tr>
				<td>HEALTH_INSURANCE_NO</td>
				<td><%=p.getHealthInsuranceNo()%></td>
				</tr>
