...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a href="<%=request.getContextPath() %>/PatientServlet?method=view">View Profile </a>
  	...
  	<a href="<%=request.getContextPath()%>/HcpServlet?method=viewPatientFromHcp">View Patients</a>
...
<tr>
		...
		<td colspan="2" style="text-align: center;padding-top: 10px"> <button type="submit" name="action" value="changepasswordhcp" onclick="return validate1();">Change Password</button> </td>
</tr>
</table>
</form>
