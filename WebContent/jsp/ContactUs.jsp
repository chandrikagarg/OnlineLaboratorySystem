...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-teal" href="<%=request.getContextPath()%>/Controller?action=view">About Us</a>
  <a class="w3-bar-item w3-button" href="<%=request.getContextPath()%>/Controller?action=create">Contact Us</a>
...
Find laboratory Services</font></b> &nbsp; &nbsp;<input type="text" name="searchbox" placeholder="City,TestName"> 
 ...
 <p align="center">A teaching hospital combines assistance to people with teaching to medical students and nurses. The medical facility smaller than a hospital is generally called a clinic. Hospitals have a range of departments (e.g. surgery and urgent care) and specialist units such as cardiology. Some hospitals have outpatient departments and some have chronic treatment units. 
